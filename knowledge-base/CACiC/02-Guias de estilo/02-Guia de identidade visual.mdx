...
Na absoluta impossibilidade de se utilizar a fonte Source Code Pro, a fonte secundária é a Inconsolata. Ela é uma fonte com alta legibilidade.

A fonte terciária é a Courier New. Ela é uma fonte comum e neutra.
...
Para mídias digitais, a cor padrão do logotipo é `#3D3F97` (RGB: 61, 63, 151).  
Para mídias impressas, considere as cores Pantone 2736C, Pantone P 104-8 U e Pantone P 102-8 C.

Outras cores podem ser utilizadas desde que respeitem os índices mínimos de contraste estabelecidos pela [WCAG 3](https://www.w3.org/WAI/standards-guidelines/wcag/wcag3-intro/) ou versão mais recente.  
...
Inteligências artificiais podem reproduzir conteúdos protegidos por direitos autorais, pois são treinadas com esse tipo de material.  
Além disso, o conteúdo gerado por inteligência artificial pode ser de baixa qualidade, o que prejudica a imagem da entidade.  
Ademais, há a questão ética.
...
Utilizar o formato SVG para ícones e logotipos, e AVIF para imagens.

Onde o AVIF não é compatível, utilizar o formato WEBP.  
Onde o WEBP não é compatível:

- Usar o formato JPEG exclusivamente para fotografias;
- Usar o formato PNG exclusivamente para elementos gráficos (logotipos, desenhos, ícones, etc);

Não usar GIF, pois é um formato obsoleto e ineficiente.

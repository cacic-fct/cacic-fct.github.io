...
| `CNAME` | analytics.cacic.dev.br     | FCTDTIWEBXP01.cacic.dev.br | Sim   | Umami Analytics                       |
| `CNAME` | a.cacic.dev.br             | FCTDTIWEBXP01.cacic.dev.br | Sim   | Umami Analytics - Alternativa adblock |

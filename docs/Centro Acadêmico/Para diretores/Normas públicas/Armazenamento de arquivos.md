...
1. É proibida a utilização de outros serviços que não sejam o Google Drive (Dropbox, Mega, Box, etc), mesmo que um professor insista. Isso evita fragmentação e perda de arquivos;
1. Não delete nenhum tipo de arquivo. O que pode parecer irrelevante para você, pode ser útil para a próxima gestão.
   - Se não há mais espaço:
     ...
     1. Transfira fotos e vídeos para o https://fotos.cacic.com.br;
